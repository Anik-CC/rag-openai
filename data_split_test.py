...
data_sample = 'Welcome to the most comprehensive AWS Cloud Development Kit (CDK) - V2 from Anik with actual enterprise hands-on implementation experience migrating large number of workloads for Fortune 100 companies using AWS CDK V2.'
